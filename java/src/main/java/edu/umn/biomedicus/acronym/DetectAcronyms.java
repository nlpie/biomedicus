...
class DetectAcronyms implements DocumentTask {
   ...
   */
  @Inject
  public DetectAcronyms(
      AcronymModel model,
      @ComponentSetting("acronym.checkParseTokens") Boolean checkParseTokens,
      @ComponentSetting("acronym.labelOtherSenses") Boolean labelOtherSenses,
